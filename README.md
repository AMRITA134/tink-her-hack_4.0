...
**Purpose:** 
- Example: implementation of app hidden inside calculator
- Example: Debugging of sos alert when the timer going off

**Key Prompts Used:**
- "I want to create a calculator as front and whena combination is given the main safety app should open"
- explain the implementation of sos message when the timer goes off
